        ...
        <article className="single-card-movie">
            ...
            <div className="cardBody">
                ...
                <div className="d-flex gap-2 mt-2">
                    <button className="btn btn-primary btn-sm me-2" onClick={() => setVerDescripcion(!verDescripcion)}>
                        {verDescripcion ? "Ver menos" : "Ver más"}
                    </button>

                    <Link className="btn btn-primary btn-sm me-2" to={`/detalle/movie/${props.datos.id}`}>
                        detalle
                    </Link>
